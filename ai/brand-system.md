...
> **Brand system v6.5 · Messaging guide v1.0 · Updated 2026-08-19**
...
- **The crowned lion.** The School's mark is the Lion of Judah wearing a crown, beside the School's name. It replaces the shield-and-ring academic seal this section used to require, which was specified but never drawn. It is two tones and no more, Word Blue and White, and its interior is left open rather than painted, so the same artwork reads on paper and on Word Blue, this door's own ground, with the ground doing the separating. It stays ecclesiastical, not governmental: the boundary against governmental iconography stands everywhere else in the house, and the lion never appears on another door's work or as decoration to make a page feel official.
