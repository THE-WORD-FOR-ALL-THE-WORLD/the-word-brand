...
> **Brand system v6.2 · Messaging guide v1.0 · Updated 2026-08-19**
...
The published masters are a vector reconstruction rather than an original drawing, so the outlines are dense polygons rather than true curves. This is invisible on screen and in normal print. Before any large-format use, a banner, a vehicle, or a building sign, the mark is redrawn as true curves and approved. Provenance is recorded at /ai/assets.json.
