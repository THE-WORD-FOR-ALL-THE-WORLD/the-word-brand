...
- **Every door carries a mark from one family grammar.** Heavy DM Sans caps converted to outlines, a hairline rule split by a single Flame tick, and the endorsement line beneath. Revival To My City's mark and the EVERY1 mark are approved. The School's seal is commissioned. Until each is approved, that door uses the parent wordmark beside its stage word, and no one draws an interim mark.
